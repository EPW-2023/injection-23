...
class ApplicantController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //ANGGOTA 2 ITU OPSIONAL

        if (isset($applicantsData['nama_anggota2'])) {
            //foto anggota 2
        ...
        //naming all uploaded files in database
